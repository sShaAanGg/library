<template>
    <div>
        <CCard class="card-base">
            <CCardBody>
                <h4 style="color:#8c5c7d"><CIcon name="cil-people" size="lg"/> 帳號管理</h4>
                <hr style="color:#2EB85C" class="mt-0 mb-2">

                <CRow class="pt-2">
                    <CCol lg="12">
                        <CButton style="float:right" variant="outline" color="success" class="mr-2 mb-4" @click="show_model('新增')"><CIcon name="cil-user-plus"/> 新增</CButton>
                    </CCol>
                </CRow>
                ...
                >
                    ...
                    <template #footer>
                        ...
                        <CButton   @click="showInsertModal = false" color="danger">返回</CButton>
                    </template>
                </CModal>
                ...
                >
                    ...
                    <template #footer>
                        ...
                        <CButton   @click="showUpdateModal = false" color="danger">返回</CButton>
                    </template>
                </CModal>
                ...
                >
                    ...
                    <template #header>
                        ...
                        <CButtonClose   @click="showUpdatePasswordModal = false" class="text-white"/>
                    </template>
                    <template #footer>
                        <CButton   @click="update_password()" color="primary">更新</CButton>
                        <CButton   @click="showUpdatePasswordModal = false" color="danger">返回</CButton>
                    </template>
                </CModal>
            </CCardBody>
        </CCard>
...
export default {
    data() {
        return {
            items: [],
            fields: [
                {key:'account'              ,label:'帳號',          _style:'width:17%'},
                {key:'name'                 ,label:'姓名',          _style:'width:17%'},
                {key:'job_number'           ,label:'工號',          _style:'width:17%'},
                {key:'dept'                 ,label:'部門',          _style:'width:17%'},
                {key:'role'                 ,label:'權限',          _style:'width:17%'},
                {key:'show_details'         ,label:'',              _style:'width:15%'}
            ],
    ...
    methods: {
        ...
        update_account() {
            ...
            for (let ix = 0; ix < this.items.length; ++ix){
                if (this.items[ix].name === this.name && this.name != this.updateName){
                    this.name = '';
                    alert('請勿使用已重複的姓名');
                    return;
                }
        ...
        update_password() {
            ...
            // if (this.updatePassword === this.newPassword) {
            //     this.newPassword    = ''
            //     this.checkPassword  = ''
            //     return alert('請勿輸入原密碼!')
            // }
