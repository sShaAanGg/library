...
function renderTitle(h, _vm, item) {
  ...
  }, compConf && compConf.renderItemTitle ? compConf.renderItemTitle(itemRender, params) : slots && slots.title ? _vm.callSlot(slots.title, params) : _tools.UtilTools.getFuncText(item.title)));
...
function renderItems(h, _vm) {
  ...
  return formItems.map(function (item, index) {
    ...
    if (compConf && compConf.renderItemContent) {
      ...
      contentVNs = ["".concat(_ctor.default.get(data, field))];
    }
    ...
    loadItem: function loadItem(list) {
      ...
      if (process.env.VUE_APP_VXE_TABLE_ENV === 'development') {
        ...
        list.forEach(function (item) {
          if (item.slots) {
            _ctor.default.each(item.slots, function (func) {
