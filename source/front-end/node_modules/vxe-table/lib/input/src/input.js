...
function getNumberValue(_vm, val) {
  ...
  return type === 'float' ? _ctor.default.toFixed(_ctor.default.floor(val, digitsValue), digitsValue) : _ctor.default.toString(val);
}
...
function renderSuffixIcon(h, _vm) {
  ...
  return icons.length ? h('span', {
    class: ['vxe-input--suffix', {
      'is--clear': isClearable && !disabled && !(inputValue === '' || _ctor.default.eqNull(inputValue))
    }],
    on: {
    ...
    dateValue: function dateValue() {
      ...
      if (inputValue && isDatePicker) {
        ...
        if (type === 'time') {
          ...
          date = _ctor.default.toStringDate(type === 'week' ? value : inputValue, dateValueFormat);
        }
  ...
  methods: {
    ...
    initValue: function initValue() {
      ...
      if (isDatePicker) {
        ...
        if (inputValue) {
          var validValue = _ctor.default.toFixed(_ctor.default.floor(inputValue, digitsValue), digitsValue);
    ...
    afterCheckValue: function afterCheckValue() {
      ...
      if (!inpAttrs.readonly) {
        if (isNumber) {
          if (inputValue) {
            var inpVal = type === 'integer' ? _ctor.default.toInteger(inputValue) : _ctor.default.toNumber(inputValue);
          ...
          if (_inpVal) {
            ...
            if (_ctor.default.isValidDate(_inpVal)) {
              if (type === 'time') {
                ...
                if (!_ctor.default.isDateSame(inputValue, _inpVal, dateLabelFormat)) {
                  if (type === 'datetime') {
                  ...
                  this.inputValue = _ctor.default.toDateString(_inpVal, dateLabelFormat);
                }
    ...
    numberChange: function numberChange(isPlus, evnt) {
      ...
      var numValue = type === 'integer' ? _ctor.default.toInteger(inputValue) : _ctor.default.toNumber(inputValue);
      var newValue = isPlus ? _ctor.default.add(numValue, stepValue) : _ctor.default.subtract(numValue, stepValue);
      var restNum;
    ...
    dateParseValue: function dateParseValue(date) {
      ...
      if (date) {
        if (type === 'time') {
          ...
          dValue = _ctor.default.toStringDate(date, valueFormat);
        }
      }
