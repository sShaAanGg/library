...
var _default2 = {
  ...
  methods: {
    ...
    removeMsgQueue: function removeMsgQueue() {
      ...
      if (msgQueue.indexOf(this) > -1) {
        _ctor.default.remove(msgQueue, function (comp) {
          return comp === _this3;
        });
      }
      ...
      if (visible) {
        Promise.resolve(beforeHideMethod ? beforeHideMethod(params) : null).then(function (rest) {
          if (!_ctor.default.isError(rest)) {
            ...
            _ctor.default.remove(allActivedModals, function (item) {
              return item === _this5;
            });
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (evnt.keyCode === 27) {
        var lastModal = _ctor.default.max(allActivedModals, function (item) {
